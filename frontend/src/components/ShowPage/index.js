...
const ShowPage = () => {
    ...
    // let related = posts.find(post => post.userId === profile).sort({ created_at: -1 }).limit(6)
    // console.log(related)
                ...
                <aside>
                    <div className="top">
                        <a href="/dsnovaes">
                            <div className="profile">
                                <img src={profileImg} alt="Diego Novaes" />
                            </div>
                            <h2>dsnovaes</h2>
                        </a>
                    </div>
                    <div className="comments">
                        ...
                        <div className="comment">
                            <a href="/dsnovaes"><img src={profileImg} alt="Diego Novaes" /></a>
                            <div>
                                <p><a href="/dsnovaes"><strong>dsnovaes</strong></a> {post.caption}</p>
                    ...
                    <div className="more">
                        ...
                        <div class="buttons">
                            ...
                            <button><svg aria-label="Comment" color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg></button>
                        </div>
